...
class AdminUsersController extends AdminController {
     ...
     */
    public function __construct(User $user, Role $role, Permission $permission, Azienda $azienda)
    {
        parent::__construct();
        $this->user = $user;
        $this->role = $role;
    ...
    public function getCreate()
    {
        ...
        // Get all the available aziende
        $aziende = $this->azienda->all();        
		...
		// Show the page
		return View::make('admin/users/create_edit', compact('roles', 'permissions', 'selectedRoles', 'selectedPermissions', 'title', 'mode', 'aziende'));
    }
    ...
    public function postCreate()
    {
        ...
        $this->user->azienda_id = Input::get( 'azienda_id' );
    ...
    public function getEdit($user)
    {
        if ( $user->id )
        {
        	...
        	return View::make('admin/users/create_edit', compact('user', 'roles', 'permissions', 'title', 'mode', 'aziende'));
        }
        else
        {
    ...
    public function postEdit($user)
    {
        ...
        if ($validator->passes())
        {
            ...
            $user->azienda_id = Input::get( 'azienda_id' );
